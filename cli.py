...
parser.add_argument("cmd", choices=[f[:-3] for f in os.listdir(TOOLS_DIR)], help="command name")
parser.add_argument('rest', metavar="args",nargs=argparse.REMAINDER, help="command arguments")
